...
<div class="header">
    <div class="container">
        <!--logo-->
        <div class="logo">
            <h1><a href="index.html">猫途鹰收藏查看</a></h1>
        </div>
        <!--//logo-->
        <div class="top-nav">
...
<script>
    $(function(){
        $.ajax({
            type : 'post',
            url : "<%=request.getContextPath()%>/DubboController/queryid.do",
            dataType : 'json',
            async:false,
            success:function(datas){
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    divid+='<a class="hvr-sweep-to-right more" onclick="shoucheng('+datas[i].scenicid+')">取消收藏</a>';
                    divid+='</div>';//
